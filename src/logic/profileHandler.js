...
export const useUpdateUser = (user,walletBalance) => {
    ...
    return {username , firstName, lastName, email, amount, defAmount,
        handleUsernameChange, handleFirstNameChange, handleLastNameChange, handleEmailChange, incrementAmount , handleSum, handleDec,handleWallet, setAmount};
};
